export type FileType = { name: string, mimes: Array<string>, extensions: Array<string> };
export type FileTypeList = { [key: string]: Array<FileType> };

let fileTypes: FileTypeList = {
    'Images': [
